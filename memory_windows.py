...
tool1=pygame.image.load("images/albums/tool_album.png").convert()
tool2=pygame.image.load("images/logos/tool_logo.png").convert()
...
tool3=pygame.mixer.Sound("musiques/tool_lateralus.wav")
